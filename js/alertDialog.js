...
class AlertDialog {
    constructor(parent) {
        ...
        // container
        this.container = DOMUtils.div({class: "igv-webapp-alert-dialog-container"});
        ...
        // body container
        let bodyContainer = DOMUtils.div({id: 'igv-webapp-alert-dialog-body'});
        this.container.appendChild(bodyContainer);

        // body copy
        this.body = DOMUtils.div({id: 'igv-webapp-alert-dialog-body-copy'});
